...
class Program(Thread):
    ...
    #Function to define initial positions of all atoms including padding
    ...
    #Function to initialize the velocity and accelation lists
    ...
    #Function to find the kinetic energy
    ...
    #Fuction to update the vpython atoms
    ...
    def run(self):
        ...
        while not self.stopped.wait(float(tstep)):
            ...
            #calling shared c object to get the potential energy value. 
            ...
            #calling shared c module to update the coordinates. 
            ...
            if (ji>=int(iter)):
                #calling shared c module to display the profiling results on screen 
                xc.profiling()
                stopFlag.set()
